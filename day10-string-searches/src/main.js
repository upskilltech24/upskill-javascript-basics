...
String indexOf() 
    ...
    - we can also  pass (find from) position as second argument to the this method, 
      to find the match from the given position
...
String search()
    - same as indexOf
    - but start position to search cannot be given here
...
String match()
    ...
    - it wont return index for regex case if there are multiple matches, /test/gi = > [TEST, test, Test]
String matchAll()
    - can take regex .match(/test/gi)
